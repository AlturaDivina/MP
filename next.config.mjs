...
const nextConfig = {
  ...
  async headers() {
    ...
    const ContentSecurityPolicy = `
      default-src 'self' https://*.mercadopago.com https://*.mlstatic.com https://*.mercadolibre.com https://*.framer.com;
      script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.mercadopago.com https://*.mlstatic.com https://*.mercadolibre.com;
      style-src 'self' 'unsafe-inline' https://*.mercadopago.com https://*.mlstatic.com https://*.mercadolibre.com;
      ...
      connect-src 'self' https://*.mercadopago.com https://api.mercadopago.com https://*.mlstatic.com https://*.framer.com https://*.mercadolibre.com https://*.mercadolivre.com;
      font-src 'self' data: https://*.mlstatic.com https://*.mercadolibre.com;
      object-src 'none';
      frame-src 'self' *;
      frame-ancestors *; 
      base-uri 'self';
